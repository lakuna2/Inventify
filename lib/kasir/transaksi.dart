...
class _TransaksiState extends State<Transaksi> {
  ...
  Future<void> _onBarcode(String code) async {
    ...
    setState(() { _loadingBarcode = true; _lastScanned = null; });
    ...
    if (inCart >= product.stock) {
      _showFeedback('${product.name} — stok hanya ${product.stock} pcs', isError: true);
      return;
    }
  ...
  @override
  void dispose() { _cart.dispose(); super.dispose(); }
...
class _ScannerArea extends StatelessWidget {
  ...
  const _ScannerArea({required this.onDetected, required this.loading, this.lastScanned});
        ...
        child: lastScanned != null
            ? Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors.tersedia.withValues(alpha: 0.3)),
                ),
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  const Icon(Icons.check_circle_outline, color: AppColors.tersedia, size: 16),
                  const SizedBox(width: 6),
                  Text('Ditambahkan: $lastScanned',
                    style: const TextStyle(fontSize: 12, color: AppColors.tersedia, fontWeight: FontWeight.w600)),
                ]),
              )
  ...
  Widget build(BuildContext context) {
    return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Text('Arahkan kamera ke barcode barang',
        style: TextStyle(fontSize: 14, color: AppColors.textDark.withValues(alpha: 0.4))),
    ]));
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Row(children: [
          Text('${cart.totalQty} item',
            style: TextStyle(fontSize: 13, color: AppColors.textGrey.withValues(alpha: 0.8))),
          const Spacer(),
          const Text('Total ', style: TextStyle(fontSize: 13, color: AppColors.textGrey)),
          Text(rupiahFormat(cart.total),
        ...
        Row(children: [
          ...
          GestureDetector(
            onTap: () => showDialog(
              ...
              builder: (ctx) => AlertDialog(
                ...
                actions: [
                  ...
                  ElevatedButton(
                    onPressed: () { cart.clear(); Navigator.pop(ctx); },
            ...
            child: Container(
              ...
              child: const Icon(Icons.delete_outline, color: AppColors.habis, size: 22),
            ),
          ),
