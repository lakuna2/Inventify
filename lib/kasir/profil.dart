...
// import 'package:inventify/widgets/profil/ubah_password_sheet.dart';
// import 'package:inventify/widgets/profil/notifikasi_sheet.dart';
// import 'package:inventify/widgets/profil/tampilan_sheet.dart';
// import 'package:inventify/widgets/profil/tentang_sheet.dart';
// import 'package:inventify/widgets/profil/bantuan_sheet.dart';
      ...
      child: Container(
        ...
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snap) {
            ...
            final nama = user['nama'] ?? FirebaseAuth.instance.currentUser?.displayName ?? 'Kasir';
            final email = user['email'] ?? FirebaseAuth.instance.currentUser?.email ?? '';
            final joinDate = (user['createdAt'] as dynamic)?.toDate() as DateTime?;
                    ...
                    ProfilMenuSection(
                      ...
                      items: [
                        ProfilMenuItem(
                          ...
                          onTap: () => EditProfilSheet.show(context, user: user),
                        ),
                        ProfilMenuItem(
                    ...
                    ProfilMenuSection(
                      ...
                      items: [
                        ...
                        ProfilMenuItem(
                          ...
                          title: 'Tampilan',
                          subtitle: 'Tema gelap / terang',
                          onTap: () => TampilanSheet.show(context),
                        ),
                        ProfilMenuItem(
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: const Icon(Icons.logout_rounded, color: AppColors.habis, size: 18),
          ),
          const SizedBox(width: 12),
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('Keluar', style: TextStyle(
              fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.habis)),
            Text('Logout dari akun ini',
              style: TextStyle(fontSize: 11, color: AppColors.habis.withValues(alpha: 0.7))),
          ]),
        ]),
      ),
    );
